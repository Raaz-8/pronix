  ...
  return (
    ...
    <div id='home'>
        ...
        <div className='flex z-0 justify-center flex-col items-center '>
                <h1 className='text-white text-4xl mt-28 max-sm:text-xl  max-sm:mt-28'>Your destination for <strong>IT SERVICES</strong></h1>
                <br/>
                ...
                <small className='mb-36 mt-16 text-white text-sm w-3/5 text-center'>Welcome to ProNix Solutions, <br/> where innovation meets technology. We are a dynamic <strong>IT solutions</strong> provider dedicated to helping businesses thrive in the digital age. <br/> With a passion for creativity and a commitment to excellence, we bring a diverse set of skills to the table, <br/> offering a <strong>wide range of services</strong> tailored to your needs.</small>
        </div>
